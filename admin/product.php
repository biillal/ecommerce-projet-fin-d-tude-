...
<body>
      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          if(isset($_GET['supprimer']) && $_GET['supprimer'] == "ok"){
                print '<div class="alert alert-success">perssones supprimer avec success </div>';
            }
          ?>
          <table class="table">
  <thead>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">1</th>
      <td class="img"><img src="../layout/product_images/<?php echo $pro_image ?>" alt=""></td>
      <td><p><?php echo $pro_title ?></p></td>
      <td><p><?php echo $pro_price ?></p></td>
      <td>
        <a href="supprimer_pro.php?id=<?php echo $row_pro['id_produit'] ?>" class="btn btn-danger">Supprimer</a>
      </td>
    </tr>
  </tbody>
  <?php
